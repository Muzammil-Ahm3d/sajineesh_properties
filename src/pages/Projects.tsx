    ...
    <div className="min-h-screen">
      ...
      < section className="section-padding" >
        <div className="container-wide">
          ...
          {isError && (
            <div className="bg-destructive/10 border border-destructive/20 text-destructive p-4 rounded-xl text-center mb-12">
              <p className="font-semibold">
                {error instanceof Error && error.message === 'UNAUTHORIZED_API'
                  ...
                  : "Failed to load dynamic projects. Showing static portfolio."
                }
              </p>
            </div>
          )}
